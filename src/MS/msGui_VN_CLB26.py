...
from PyQt5.QtWidgets import (QMainWindow, QApplication, QWidget,
                             QPushButton, QAction, QLineEdit, QMessageBox, QLabel, QDial)
...
class App(QMainWindow):
    ...
    def initUI(self):
        ...
        self.loginLabel.move(10, 10)
        self.loginLabel.setText('Login : ')

        self.loginTextbox = QLineEdit(self)
        self.loginTextbox.move(47, 15)
        self.loginTextbox.resize(100, 20)
        ...
        self.passTextbox.move(47, 45)
        self.passTextbox.resize(100, 20)
        self.passTextbox.setEchoMode(QLineEdit.Password)

        self.countLabel = QLabel(self)
        self.countLabel.move(10, 70)
        self.countLabel.setText('Count : ')

        self.countTextbox = QLineEdit(self)
        self.countTextbox.move(47, 75)
        self.countTextbox.resize(100, 20)

        self.button = QPushButton('Start', self)
        self.button.move(10, 100)

        self.button.clicked.connect(self.on_click)
        self.button.resize(137,30)
    ...
    def on_click(self):
        ...
        for num in range(count):
          ...
          #  for number in range(4):
            ...
            #      '/')
            press('f', ',', 'j', 'y', 't', 'y', 'n', 'c', 'r', 'b', 'q', 'spacebar', 'g', 'e', 'y', 'r', 'n', 'spacebar', 'c', 'j', 'p', 'l', 'f', 'y', '/')
        ...
        QMessageBox.information(self, 'Результат ', 'Обработано ' + str(count) + ' обращений.', QMessageBox.Ok, QMessageBox.Ok)
